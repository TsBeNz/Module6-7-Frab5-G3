...
dist = np.load(
    "C:/github/Module6-7/High_Lv/moduleM1/setting/"+"dist.npy")
mtx = np.load(
    "C:/github/Module6-7/High_Lv/moduleM1/setting/"+"mtx.npy")
ret = np.load(
    "C:/github/Module6-7/High_Lv/moduleM1/setting/"+"ret.npy")
rvecs = np.load(
    "C:/github/Module6-7/High_Lv/moduleM1/setting/"+"rvecs.npy")
tvecs = np.load(
    "C:/github/Module6-7/High_Lv/moduleM1/setting/"+"tvecs.npy")
